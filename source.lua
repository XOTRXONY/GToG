...
local conLabel = Instance.new("TextLabel")
conLabel.Name = "CONLabel"
conLabel.Size = UDim2.new(1, -30, 1, 0)
conLabel.Position = UDim2.new(0, 0, 0, 0)
conLabel.BackgroundTransparency = 1
conLabel.Text = "CON"
conLabel.TextColor3 = Color3.fromRGB(200, 200, 200)
conLabel.TextSize = 16
conLabel.Font = Enum.Font.GothamMedium
conLabel.TextXAlignment = Enum.TextXAlignment.Center
conLabel.Parent = mainFrame
...
conLabel.MouseEnter:Connect(function()
	if not dragging then
		TweenService:Create(conLabel, TweenInfo.new(0.2), {
			TextColor3 = Color3.fromRGB(255, 255, 255),
		}):Play()
	end
end)

conLabel.MouseLeave:Connect(function()
	if not dragging then
		TweenService:Create(conLabel, TweenInfo.new(0.2), {
...
mainFrame.InputBegan:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		spawn(function()
			wait(holdThreshold)
			if dragStart and (tick() - clickStartTime) >= holdThreshold then
				dragging = true
...
mainFrame.InputEnded:Connect(function(input)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		if clickDuration < holdThreshold and not dragging then
			TweenService:Create(mainFrame, TweenInfo.new(0.1), {
...
closeButton.MouseButton1Click:Connect(function()
	...
	TweenService:Create(conLabel, TweenInfo.new(0.3), {
		TextTransparency = 1,
	}):Play()
...
TweenService:Create(conLabel, TweenInfo.new(0.5), {
	TextTransparency = 0,
}):Play()
