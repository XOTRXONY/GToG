if IY_LN and not _G.IY_DEUBG == true then
    -- error("Infinite Yield is already running!", 0)
    return
end

pcall(function() getgenv().IY_LN = true end)
...
-- xylex & europa
local iyassets = {
    ["INF9.9.9/assets/bindsandplugins.png"] = "rbxassetid://5147695474",
    ["INF9.9.9/assets/close.png"] = "rbxassetid://5054663650",
    ["INF9.9.9/assets/editaliases.png"] = "rbxassetid://5147488658",
    ["INF9.9.9/assets/editkeybinds.png"] = "rbxassetid://129697930",
    ["INF9.9.9/assets/edittheme.png"] = "rbxassetid://4911962991",
    ["INF9.9.9/assets/editwaypoints.png"] = "rbxassetid://5147488592",
    ["INF9.9.9/assets/imgstudiopluginlogo.png"] = "rbxassetid://78252092662741",
    ["INF9.9.9/assets/logo.png"] = "rbxassetid://78252092662741",
    ["INF9.9.9/assets/minimize.png"] = "rbxassetid://2406617031",
    ["INF9.9.9/assets/pin.png"] = "rbxassetid://100309677953436",
    ["INF9.9.9/assets/reference.png"] = "rbxassetid://3523243755",
    ["INF9.9.9/assets/settings.png"] = "rbxassetid://1204397029"
}
...
if makefolder and isfolder and writefile and isfile then
    pcall(function() -- good executor trust
        ...
        for _, folder in {"INF9.9.9", "INF9.9.9/assets"} do
        ...
        for path in iyassets do
            if not isfile(path) then
                writefile(path, game:HttpGet((path:gsub("INF9.9.9/", assets))))
            end
        end
        if IsOnMobile then writefile("INF9.9.9/assets/.nomedia") end
    end)
end
...
SettingsButton.Image = getcustomasset("INF9.9.9/assets/settings.png")
...
ReferenceButton.Image = getcustomasset("INF9.9.9/assets/reference.png")
...
ColorsButton = makeSettingsButton("Edit Theme",getcustomasset("INF9.9.9/assets/edittheme.png"))
ColorsButton.Position = UDim2.new(0, 5, 0, 55)
ColorsButton.Size = UDim2.new(1, -10, 0, 25)
ColorsButton.Name = "Colors"
ColorsButton.Parent = SettingsHolder

Keybinds = makeSettingsButton("Edit Keybinds",getcustomasset("INF9.9.9/assets/editkeybinds.png"))
Keybinds.Position = UDim2.new(0, 5, 0, 85)
Keybinds.Size = UDim2.new(1, -10, 0, 25)
Keybinds.Name = "Keybinds"
Keybinds.Parent = SettingsHolder

Aliases = makeSettingsButton("Edit Aliases",getcustomasset("INF9.9.9/assets/editaliases.png"))
...
Positions = makeSettingsButton("Edit/Goto Waypoints",getcustomasset("INF9.9.9/assets/editwaypoints.png"))
Positions.Position = UDim2.new(0, 5, 0, 145)
Positions.Size = UDim2.new(1, -10, 0, 25)
Positions.Name = "Waypoints"
Positions.Parent = SettingsHolder

EventBind = makeSettingsButton("Edit Event Binds",getcustomasset("INF9.9.9/assets/bindsandplugins.png"),759)
EventBind.Position = UDim2.new(0, 5, 0, 205)
EventBind.Size = UDim2.new(1, -10, 0, 25)
EventBind.Name = "EventBinds"
EventBind.Parent = SettingsHolder

Plugins = makeSettingsButton("Manage Plugins",getcustomasset("INF9.9.9/assets/bindsandplugins.png"),743)
...
CloseImage.Image = getcustomasset("INF9.9.9/assets/close.png")
...
PinImage.ZIndex = 10
PinImage.Image = getcustomasset("INF9.9.9/assets/pin.png")
...
Logo.Image = getcustomasset("INF9.9.9/assets/logo.png")
...
Credits.Text = "Du8 \n Edge // Zwolf // Moon // Toon // Peyton // ATP"
...
ExitImage_2.Image = getcustomasset("INF9.9.9/assets/close.png")
...
Img.Image = getcustomasset("INF9.9.9/assets/imgstudiopluginlogo.png")
Img.ZIndex = 10
...
ExitImage_3.Image = getcustomasset("INF9.9.9/assets/close.png")
...
ExitImage_5.Image = getcustomasset("INF9.9.9/assets/close.png")
...
ImageLabel.Image = getcustomasset("INF9.9.9/assets/minimize.png")
...
ImageLabel_2.Image = getcustomasset("INF9.9.9/assets/close.png")
...
eventEditor = (function()
	...
	local main = create({
		...
		{5,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("INF9.9.9/assets/close.png"),Parent={4},Position=UDim2.new(0,5,0,5),Size=UDim2.new(0,10,0,10),ZIndex=10,}},
		...
		{53,"ImageLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Image=getcustomasset("INF9.9.9/assets/settings.png"),Parent={52},Position=UDim2.new(0,2,0,2),Size=UDim2.new(0,16,0,16),ZIndex=10,}},
	})
	main.Name = randomString()
...
reference = (function()
	local main = create({
		...
		{16,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="CaseName",Parent={15},Size=UDim2.new(1,0,1,0),Text="Du8-",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		{17,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="By du8 Second revised version",Parent={15},Position=UDim2.new(0,15,0,0),Size=UDim2.new(1,0,1,0),Text="- Added more creative instructions",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
		...
		{113,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=4,Name="Header",Parent={112},Position=UDim2.new(0,8,0,5),Size=UDim2.new(1,-8,0,20),Text="关于",TextColor3=Color3.new(1,1,1),TextSize=20,TextXAlignment=0,ZIndex=10,}},
		{114,"TextLabel",{BackgroundColor3=Color3.new(1,1,1),BackgroundTransparency=1,Font=3,Name="Text",Parent={112},Position=UDim2.new(0,8,0,30),Size=UDim2.new(1,-8,0,32),Text="这个版本添加了更多创作性指令 by du8 On 2025 8 18.",TextColor3=Color3.new(1,1,1),TextSize=14,TextWrapped=true,TextXAlignment=0,ZIndex=10,}},
...
createPopup = function(text)
    ...
    ExitImage.Image = getcustomasset("INF9.9.9/assets/close.png")
    ExitImage.ZIndex = 10
...
function saves()
    if writefileExploit() and readfileExploit() and jsonAttempts < 10 then
        local readSuccess, out = readfile("IY_FE999.iy", true)
        if readSuccess then
            if out ~= nil and tostring(out):gsub("%s", "") ~= "" then
                ...
                if not success then
                    ...
                    writefile("IY_FE999.iy", defaults, true)
                    wait()
                    saves()
                end
            else
                writefile("IY_FE999.iy", defaults, true)
                wait()
                local dReadSuccess, dOut = readfile("IY_FE999.iy", true)
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("IY_FE999.iy", HttpService:JSONEncode(update))
	end
end
...
CMDs[#CMDs + 1] = {NAME = 'Insole', DESC = 'Open Roblox console (Button)'}
CMDs[#CMDs + 1] = {NAME = 'oldconsole', DESC = 'Loads old Roblox console'}
CMDs[#CMDs + 1] = {NAME = 'explorer / dex', DESC = 'Opens DEX by Moon'}
CMDs[#CMDs + 1] = {NAME = 'dex+ / Dj', DESC = 'Opens DEX++'}
CMDs[#CMDs + 1] = {NAME = 'olddex / odex', DESC = 'Opens Old DEX by Moon'}
CMDs[#CMDs + 1] = {NAME = 'removtespyV2 / rspy2', DESC = 'Opens Rspy 2'} -- 😂😂😂😂😂😂
			...
			if cmd then
				...
				if infTimes then
					while lastBreakTime < cmdStartTime do
						...
						if not success and _G.IY_DEUBG then
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'IY_FE999.iy' or name == 'iy_fe' then
...
Players.LocalPlayer.OnTeleport:Connect(function(State)
	if KeepInfYield and (not TeleportCheck) and queueteleport then
		TeleportCheck = true
		queueteleport("loadstring(game:HttpGet('https://raw.githubusercontent.com/XOTRXONY/GToG/refs/heads/main/source.lua'))()")
	end
end)
...
addcmd("Insole", {}, function(args, speaker) -- 👿👿
   ...
   mf.Name = "MainFrame"
   mf.Size = UDim2.new(0, 100, 0, 40)
   mf.Position = UDim2.new(0.5, -50, 0.1, 0)
   ...
   cb.Position = UDim2.new(1, -30, 0.5, -12.5)
   cb.BackgroundColor3 = Color3.fromRGB(25, 25, 25)
   ...
   cl.MouseEnter:Connect(function()
       if not d then
           ts:Create(cl, TweenInfo.new(0.2), {
   ...
   cb.MouseEnter:Connect(function()
       ts:Create(cb, TweenInfo.new(0.2), {
   ...
   mf.InputBegan:Connect(function(input)
       if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
           ...
           spawn(function()
               wait(ht)
               if ds and (tick() - ct) >= ht then
                   d = true

                   ts:Create(mf, TweenInfo.new(0.1), {
                       BackgroundColor3 = Color3.fromRGB(25, 25, 25),
                   }):Play()
               end
           end)
   ...
   mf.InputEnded:Connect(function(input)
       if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
           ...
           ts:Create(mf, TweenInfo.new(0.2), {
   ...
   uis.InputChanged:Connect(function(input)
       if d and ds and (input.UserInputType == Enum.UserInputType.MouseMovement or input.UserInputType == Enum.UserInputType.Touch) then
           local delta = input.Position - ds
           local np = UDim2.new(sp.X.Scale, sp.X.Offset + delta.X, sp.Y.Scale, sp.Y.Offset + delta.Y)
           mf.Position = np
       end
   end)

   cb.MouseButton1Click:Connect(function()
       ts:Create(mf, TweenInfo.new(0.3, Enum.EasingStyle.Back, Enum.EasingDirection.In), {
           Size = UDim2.new(0, 0, 0, 0),
           BackgroundTransparency = 1,
       }):Play()

       ts:Create(cl, TweenInfo.new(0.3), {
           TextTransparency = 1,
       }):Play()

       ts:Create(cb, TweenInfo.new(0.3), {
           TextTransparency = 1,
           BackgroundTransparency = 1,
       }):Play()
   ...
   ts:Create(cl, TweenInfo.new(0.5), {
       TextTransparency = 0,
   }):Play()

   ts:Create(cb, TweenInfo.new(0.5), {
       TextTransparency = 0,
       BackgroundTransparency = 0,
   }):Play()
end)
...
addcmd("dex+", {"dj"}, function(args, speaker)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/XOTRXONY/GToG/refs/heads/main/Dex%2B%2B.lua"))()
end)
...
addcmd("removtespyV2", {"rspy2"}, function(args, speaker)
    loadstring(game:HttpGet("https://raw.githubusercontent.com/XOTRXONY/GToG/refs/heads/main/v2.lua"))()
end)
...
addcmd("addallplugins", {"loadallplugins"}, function(args, speaker)
    ...
    for _, filePath in ipairs(listfiles("")) do
        ...
        if fileName and
            fileName:lower() ~= "IY_FE999.iy" and
...
task.spawn(function()
	local success, latestVersionInfo = pcall(function() 
		local versionJson = game:HttpGet("https://pastefy.app/kD1mUzyv/raw")
		return HttpService:JSONDecode(versionJson)
	end)

	if success then
		if currentVersion ~= latestVersionInfo.Version then
			notify("Outdated", "Ok infyiff.github.io")
		end
